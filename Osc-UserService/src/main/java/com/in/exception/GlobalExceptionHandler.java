...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BlankResultException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<String> blankDataException(BlankResultException ex) {
        return new ResponseEntity<>(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<DataResponse> handleAllExceptions(Exception ex) {
        DataResponse response = new DataResponse(0, null);
