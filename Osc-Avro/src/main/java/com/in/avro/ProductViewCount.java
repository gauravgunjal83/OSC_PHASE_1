...
public class ProductViewCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3485798561044619775L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductViewCount\",\"namespace\":\"com.in.avro\",\"fields\":[{\"name\":\"count\",\"type\":\"int\"},{\"name\":\"categoryId\",\"type\":\"string\"}]}");
   ...
   */
  public ProductViewCount(java.lang.Integer count, java.lang.CharSequence categoryId) {
    this.count = count;
   ...
   */
  public static com.in.avro.ProductViewCount.Builder newBuilder() {
    return new com.in.avro.ProductViewCount.Builder();
  }
   ...
   * @return A new ProductViewCount RecordBuilder
   */
  public static com.in.avro.ProductViewCount.Builder newBuilder(com.in.avro.ProductViewCount.Builder other) {
    if (other == null) {
      return new com.in.avro.ProductViewCount.Builder();
    } else {
      return new com.in.avro.ProductViewCount.Builder(other);
    }
  }
   ...
   * @return A new ProductViewCount RecordBuilder
   */
  public static com.in.avro.ProductViewCount.Builder newBuilder(com.in.avro.ProductViewCount other) {
    if (other == null) {
      return new com.in.avro.ProductViewCount.Builder();
    } else {
      return new com.in.avro.ProductViewCount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductViewCount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.in.avro.ProductViewCount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.in.avro.ProductViewCount other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.count)) {
        this.count = data().deepCopy(fields()[0].schema(), other.count);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.in.avro.ProductViewCount.Builder setCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.in.avro.ProductViewCount.Builder clearCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.in.avro.ProductViewCount.Builder setCategoryId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.in.avro.ProductViewCount.Builder clearCategoryId() {
      categoryId = null;
